...
module pcihellocore_mm_interconnect_0 (
		...
		output wire [1:0]  button0_s1_address,                       //                         button0_s1.address
		input  wire [31:0] button0_s1_readdata,                      //                                   .readdata
		output wire [1:0]  cool_s1_address,                          //                            cool_s1.address
		output wire        cool_s1_write,                            //                                   .write
		input  wire [31:0] cool_s1_readdata,                         //                                   .readdata
		output wire [31:0] cool_s1_writedata,                        //                                   .writedata
		output wire        cool_s1_chipselect,                       //                                   .chipselect
		...
		output wire [1:0]  ledextra_s1_address,                      //                        ledextra_s1.address
		output wire        ledextra_s1_write,                        //                                   .write
		input  wire [31:0] ledextra_s1_readdata,                     //                                   .readdata
		output wire [31:0] ledextra_s1_writedata,                    //                                   .writedata
		output wire        ledextra_s1_chipselect,                   //                                   .chipselect
	...
	wire   [31:0] ledverde_s1_agent_m0_address;                                           // ledverde_s1_agent:m0_address -> ledverde_s1_translator:uav_address
	...
	wire  [115:0] ledverde_s1_agent_rf_source_data;                                       // ledverde_s1_agent:rf_source_data -> ledverde_s1_agent_rsp_fifo:in_data
	...
	wire  [115:0] ledverde_s1_agent_rsp_fifo_out_data;                                    // ledverde_s1_agent_rsp_fifo:out_data -> ledverde_s1_agent:rf_sink_data
	...
	wire   [31:0] ledvermelho_s1_agent_m0_address;                                        // ledvermelho_s1_agent:m0_address -> ledvermelho_s1_translator:uav_address
	...
	wire  [115:0] ledvermelho_s1_agent_rf_source_data;                                    // ledvermelho_s1_agent:rf_source_data -> ledvermelho_s1_agent_rsp_fifo:in_data
	...
	wire  [115:0] ledvermelho_s1_agent_rsp_fifo_out_data;                                 // ledvermelho_s1_agent_rsp_fifo:out_data -> ledvermelho_s1_agent:rf_sink_data
	...
	wire   [31:0] button0_s1_agent_m0_readdata;                                           // button0_s1_translator:uav_readdata -> button0_s1_agent:m0_readdata
	wire          button0_s1_agent_m0_waitrequest;                                        // button0_s1_translator:uav_waitrequest -> button0_s1_agent:m0_waitrequest
	wire          button0_s1_agent_m0_debugaccess;                                        // button0_s1_agent:m0_debugaccess -> button0_s1_translator:uav_debugaccess
	wire   [31:0] button0_s1_agent_m0_address;                                            // button0_s1_agent:m0_address -> button0_s1_translator:uav_address
	wire    [3:0] button0_s1_agent_m0_byteenable;                                         // button0_s1_agent:m0_byteenable -> button0_s1_translator:uav_byteenable
	wire          button0_s1_agent_m0_read;                                               // button0_s1_agent:m0_read -> button0_s1_translator:uav_read
	wire          button0_s1_agent_m0_readdatavalid;                                      // button0_s1_translator:uav_readdatavalid -> button0_s1_agent:m0_readdatavalid
	wire          button0_s1_agent_m0_lock;                                               // button0_s1_agent:m0_lock -> button0_s1_translator:uav_lock
	wire   [31:0] button0_s1_agent_m0_writedata;                                          // button0_s1_agent:m0_writedata -> button0_s1_translator:uav_writedata
	wire          button0_s1_agent_m0_write;                                              // button0_s1_agent:m0_write -> button0_s1_translator:uav_write
	wire    [2:0] button0_s1_agent_m0_burstcount;                                         // button0_s1_agent:m0_burstcount -> button0_s1_translator:uav_burstcount
	wire          button0_s1_agent_rf_source_valid;                                       // button0_s1_agent:rf_source_valid -> button0_s1_agent_rsp_fifo:in_valid
	wire  [115:0] button0_s1_agent_rf_source_data;                                        // button0_s1_agent:rf_source_data -> button0_s1_agent_rsp_fifo:in_data
	wire          button0_s1_agent_rf_source_ready;                                       // button0_s1_agent_rsp_fifo:in_ready -> button0_s1_agent:rf_source_ready
	wire          button0_s1_agent_rf_source_startofpacket;                               // button0_s1_agent:rf_source_startofpacket -> button0_s1_agent_rsp_fifo:in_startofpacket
	wire          button0_s1_agent_rf_source_endofpacket;                                 // button0_s1_agent:rf_source_endofpacket -> button0_s1_agent_rsp_fifo:in_endofpacket
	wire          button0_s1_agent_rsp_fifo_out_valid;                                    // button0_s1_agent_rsp_fifo:out_valid -> button0_s1_agent:rf_sink_valid
	wire  [115:0] button0_s1_agent_rsp_fifo_out_data;                                     // button0_s1_agent_rsp_fifo:out_data -> button0_s1_agent:rf_sink_data
	wire          button0_s1_agent_rsp_fifo_out_ready;                                    // button0_s1_agent:rf_sink_ready -> button0_s1_agent_rsp_fifo:out_ready
	wire          button0_s1_agent_rsp_fifo_out_startofpacket;                            // button0_s1_agent_rsp_fifo:out_startofpacket -> button0_s1_agent:rf_sink_startofpacket
	wire          button0_s1_agent_rsp_fifo_out_endofpacket;                              // button0_s1_agent_rsp_fifo:out_endofpacket -> button0_s1_agent:rf_sink_endofpacket
	wire   [31:0] ledextra_s1_agent_m0_readdata;                                          // ledextra_s1_translator:uav_readdata -> ledextra_s1_agent:m0_readdata
	wire          ledextra_s1_agent_m0_waitrequest;                                       // ledextra_s1_translator:uav_waitrequest -> ledextra_s1_agent:m0_waitrequest
	wire          ledextra_s1_agent_m0_debugaccess;                                       // ledextra_s1_agent:m0_debugaccess -> ledextra_s1_translator:uav_debugaccess
	wire   [31:0] ledextra_s1_agent_m0_address;                                           // ledextra_s1_agent:m0_address -> ledextra_s1_translator:uav_address
	wire    [3:0] ledextra_s1_agent_m0_byteenable;                                        // ledextra_s1_agent:m0_byteenable -> ledextra_s1_translator:uav_byteenable
	wire          ledextra_s1_agent_m0_read;                                              // ledextra_s1_agent:m0_read -> ledextra_s1_translator:uav_read
	wire          ledextra_s1_agent_m0_readdatavalid;                                     // ledextra_s1_translator:uav_readdatavalid -> ledextra_s1_agent:m0_readdatavalid
	wire          ledextra_s1_agent_m0_lock;                                              // ledextra_s1_agent:m0_lock -> ledextra_s1_translator:uav_lock
	wire   [31:0] ledextra_s1_agent_m0_writedata;                                         // ledextra_s1_agent:m0_writedata -> ledextra_s1_translator:uav_writedata
	wire          ledextra_s1_agent_m0_write;                                             // ledextra_s1_agent:m0_write -> ledextra_s1_translator:uav_write
	wire    [2:0] ledextra_s1_agent_m0_burstcount;                                        // ledextra_s1_agent:m0_burstcount -> ledextra_s1_translator:uav_burstcount
	wire          ledextra_s1_agent_rf_source_valid;                                      // ledextra_s1_agent:rf_source_valid -> ledextra_s1_agent_rsp_fifo:in_valid
	wire  [115:0] ledextra_s1_agent_rf_source_data;                                       // ledextra_s1_agent:rf_source_data -> ledextra_s1_agent_rsp_fifo:in_data
	wire          ledextra_s1_agent_rf_source_ready;                                      // ledextra_s1_agent_rsp_fifo:in_ready -> ledextra_s1_agent:rf_source_ready
	wire          ledextra_s1_agent_rf_source_startofpacket;                              // ledextra_s1_agent:rf_source_startofpacket -> ledextra_s1_agent_rsp_fifo:in_startofpacket
	wire          ledextra_s1_agent_rf_source_endofpacket;                                // ledextra_s1_agent:rf_source_endofpacket -> ledextra_s1_agent_rsp_fifo:in_endofpacket
	wire          ledextra_s1_agent_rsp_fifo_out_valid;                                   // ledextra_s1_agent_rsp_fifo:out_valid -> ledextra_s1_agent:rf_sink_valid
	wire  [115:0] ledextra_s1_agent_rsp_fifo_out_data;                                    // ledextra_s1_agent_rsp_fifo:out_data -> ledextra_s1_agent:rf_sink_data
	wire          ledextra_s1_agent_rsp_fifo_out_ready;                                   // ledextra_s1_agent:rf_sink_ready -> ledextra_s1_agent_rsp_fifo:out_ready
	wire          ledextra_s1_agent_rsp_fifo_out_startofpacket;                           // ledextra_s1_agent_rsp_fifo:out_startofpacket -> ledextra_s1_agent:rf_sink_startofpacket
	wire          ledextra_s1_agent_rsp_fifo_out_endofpacket;                             // ledextra_s1_agent_rsp_fifo:out_endofpacket -> ledextra_s1_agent:rf_sink_endofpacket
	wire   [31:0] cool_s1_agent_m0_readdata;                                              // cool_s1_translator:uav_readdata -> cool_s1_agent:m0_readdata
	wire          cool_s1_agent_m0_waitrequest;                                           // cool_s1_translator:uav_waitrequest -> cool_s1_agent:m0_waitrequest
	wire          cool_s1_agent_m0_debugaccess;                                           // cool_s1_agent:m0_debugaccess -> cool_s1_translator:uav_debugaccess
	wire   [31:0] cool_s1_agent_m0_address;                                               // cool_s1_agent:m0_address -> cool_s1_translator:uav_address
	wire    [3:0] cool_s1_agent_m0_byteenable;                                            // cool_s1_agent:m0_byteenable -> cool_s1_translator:uav_byteenable
	wire          cool_s1_agent_m0_read;                                                  // cool_s1_agent:m0_read -> cool_s1_translator:uav_read
	wire          cool_s1_agent_m0_readdatavalid;                                         // cool_s1_translator:uav_readdatavalid -> cool_s1_agent:m0_readdatavalid
	wire          cool_s1_agent_m0_lock;                                                  // cool_s1_agent:m0_lock -> cool_s1_translator:uav_lock
	wire   [31:0] cool_s1_agent_m0_writedata;                                             // cool_s1_agent:m0_writedata -> cool_s1_translator:uav_writedata
	wire          cool_s1_agent_m0_write;                                                 // cool_s1_agent:m0_write -> cool_s1_translator:uav_write
	wire    [2:0] cool_s1_agent_m0_burstcount;                                            // cool_s1_agent:m0_burstcount -> cool_s1_translator:uav_burstcount
	wire          cool_s1_agent_rf_source_valid;                                          // cool_s1_agent:rf_source_valid -> cool_s1_agent_rsp_fifo:in_valid
	wire  [115:0] cool_s1_agent_rf_source_data;                                           // cool_s1_agent:rf_source_data -> cool_s1_agent_rsp_fifo:in_data
	wire          cool_s1_agent_rf_source_ready;                                          // cool_s1_agent_rsp_fifo:in_ready -> cool_s1_agent:rf_source_ready
	wire          cool_s1_agent_rf_source_startofpacket;                                  // cool_s1_agent:rf_source_startofpacket -> cool_s1_agent_rsp_fifo:in_startofpacket
	wire          cool_s1_agent_rf_source_endofpacket;                                    // cool_s1_agent:rf_source_endofpacket -> cool_s1_agent_rsp_fifo:in_endofpacket
	wire          cool_s1_agent_rsp_fifo_out_valid;                                       // cool_s1_agent_rsp_fifo:out_valid -> cool_s1_agent:rf_sink_valid
	wire  [115:0] cool_s1_agent_rsp_fifo_out_data;                                        // cool_s1_agent_rsp_fifo:out_data -> cool_s1_agent:rf_sink_data
	wire          cool_s1_agent_rsp_fifo_out_ready;                                       // cool_s1_agent:rf_sink_ready -> cool_s1_agent_rsp_fifo:out_ready
	wire          cool_s1_agent_rsp_fifo_out_startofpacket;                               // cool_s1_agent_rsp_fifo:out_startofpacket -> cool_s1_agent:rf_sink_startofpacket
	wire          cool_s1_agent_rsp_fifo_out_endofpacket;                                 // cool_s1_agent_rsp_fifo:out_endofpacket -> cool_s1_agent:rf_sink_endofpacket
	...
	wire          ledverde_s1_agent_rp_valid;                                             // ledverde_s1_agent:rp_valid -> router_004:sink_valid
	wire  [114:0] ledverde_s1_agent_rp_data;                                              // ledverde_s1_agent:rp_data -> router_004:sink_data
	wire          ledverde_s1_agent_rp_ready;                                             // router_004:sink_ready -> ledverde_s1_agent:rp_ready
	wire          ledverde_s1_agent_rp_startofpacket;                                     // ledverde_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          ledverde_s1_agent_rp_endofpacket;                                       // ledverde_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	wire          ledvermelho_s1_agent_rp_valid;                                          // ledvermelho_s1_agent:rp_valid -> router_005:sink_valid
	wire  [114:0] ledvermelho_s1_agent_rp_data;                                           // ledvermelho_s1_agent:rp_data -> router_005:sink_data
	wire          ledvermelho_s1_agent_rp_ready;                                          // router_005:sink_ready -> ledvermelho_s1_agent:rp_ready
	wire          ledvermelho_s1_agent_rp_startofpacket;                                  // ledvermelho_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          ledvermelho_s1_agent_rp_endofpacket;                                    // ledvermelho_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	wire          button0_s1_agent_rp_valid;                                              // button0_s1_agent:rp_valid -> router_006:sink_valid
	wire  [114:0] button0_s1_agent_rp_data;                                               // button0_s1_agent:rp_data -> router_006:sink_data
	wire          button0_s1_agent_rp_ready;                                              // router_006:sink_ready -> button0_s1_agent:rp_ready
	wire          button0_s1_agent_rp_startofpacket;                                      // button0_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          button0_s1_agent_rp_endofpacket;                                        // button0_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	wire          ledextra_s1_agent_rp_valid;                                             // ledextra_s1_agent:rp_valid -> router_007:sink_valid
	wire  [114:0] ledextra_s1_agent_rp_data;                                              // ledextra_s1_agent:rp_data -> router_007:sink_data
	wire          ledextra_s1_agent_rp_ready;                                             // router_007:sink_ready -> ledextra_s1_agent:rp_ready
	wire          ledextra_s1_agent_rp_startofpacket;                                     // ledextra_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          ledextra_s1_agent_rp_endofpacket;                                       // ledextra_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	wire          cool_s1_agent_rp_valid;                                                 // cool_s1_agent:rp_valid -> router_008:sink_valid
	wire  [114:0] cool_s1_agent_rp_data;                                                  // cool_s1_agent:rp_data -> router_008:sink_data
	wire          cool_s1_agent_rp_ready;                                                 // router_008:sink_ready -> cool_s1_agent:rp_ready
	wire          cool_s1_agent_rp_startofpacket;                                         // cool_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          cool_s1_agent_rp_endofpacket;                                           // cool_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          ledverde_s1_burst_adapter_source0_valid;                                // ledverde_s1_burst_adapter:source0_valid -> ledverde_s1_agent:cp_valid
	wire  [114:0] ledverde_s1_burst_adapter_source0_data;                                 // ledverde_s1_burst_adapter:source0_data -> ledverde_s1_agent:cp_data
	wire          ledverde_s1_burst_adapter_source0_ready;                                // ledverde_s1_agent:cp_ready -> ledverde_s1_burst_adapter:source0_ready
	wire    [8:0] ledverde_s1_burst_adapter_source0_channel;                              // ledverde_s1_burst_adapter:source0_channel -> ledverde_s1_agent:cp_channel
	wire          ledverde_s1_burst_adapter_source0_startofpacket;                        // ledverde_s1_burst_adapter:source0_startofpacket -> ledverde_s1_agent:cp_startofpacket
	wire          ledverde_s1_burst_adapter_source0_endofpacket;                          // ledverde_s1_burst_adapter:source0_endofpacket -> ledverde_s1_agent:cp_endofpacket
	wire          ledvermelho_s1_burst_adapter_source0_valid;                             // ledvermelho_s1_burst_adapter:source0_valid -> ledvermelho_s1_agent:cp_valid
	wire  [114:0] ledvermelho_s1_burst_adapter_source0_data;                              // ledvermelho_s1_burst_adapter:source0_data -> ledvermelho_s1_agent:cp_data
	wire          ledvermelho_s1_burst_adapter_source0_ready;                             // ledvermelho_s1_agent:cp_ready -> ledvermelho_s1_burst_adapter:source0_ready
	wire    [8:0] ledvermelho_s1_burst_adapter_source0_channel;                           // ledvermelho_s1_burst_adapter:source0_channel -> ledvermelho_s1_agent:cp_channel
	wire          ledvermelho_s1_burst_adapter_source0_startofpacket;                     // ledvermelho_s1_burst_adapter:source0_startofpacket -> ledvermelho_s1_agent:cp_startofpacket
	wire          ledvermelho_s1_burst_adapter_source0_endofpacket;                       // ledvermelho_s1_burst_adapter:source0_endofpacket -> ledvermelho_s1_agent:cp_endofpacket
	wire          button0_s1_burst_adapter_source0_valid;                                 // button0_s1_burst_adapter:source0_valid -> button0_s1_agent:cp_valid
	wire  [114:0] button0_s1_burst_adapter_source0_data;                                  // button0_s1_burst_adapter:source0_data -> button0_s1_agent:cp_data
	wire          button0_s1_burst_adapter_source0_ready;                                 // button0_s1_agent:cp_ready -> button0_s1_burst_adapter:source0_ready
	wire    [8:0] button0_s1_burst_adapter_source0_channel;                               // button0_s1_burst_adapter:source0_channel -> button0_s1_agent:cp_channel
	wire          button0_s1_burst_adapter_source0_startofpacket;                         // button0_s1_burst_adapter:source0_startofpacket -> button0_s1_agent:cp_startofpacket
	wire          button0_s1_burst_adapter_source0_endofpacket;                           // button0_s1_burst_adapter:source0_endofpacket -> button0_s1_agent:cp_endofpacket
	wire          ledextra_s1_burst_adapter_source0_valid;                                // ledextra_s1_burst_adapter:source0_valid -> ledextra_s1_agent:cp_valid
	wire  [114:0] ledextra_s1_burst_adapter_source0_data;                                 // ledextra_s1_burst_adapter:source0_data -> ledextra_s1_agent:cp_data
	wire          ledextra_s1_burst_adapter_source0_ready;                                // ledextra_s1_agent:cp_ready -> ledextra_s1_burst_adapter:source0_ready
	wire    [8:0] ledextra_s1_burst_adapter_source0_channel;                              // ledextra_s1_burst_adapter:source0_channel -> ledextra_s1_agent:cp_channel
	wire          ledextra_s1_burst_adapter_source0_startofpacket;                        // ledextra_s1_burst_adapter:source0_startofpacket -> ledextra_s1_agent:cp_startofpacket
	wire          ledextra_s1_burst_adapter_source0_endofpacket;                          // ledextra_s1_burst_adapter:source0_endofpacket -> ledextra_s1_agent:cp_endofpacket
	wire          cool_s1_burst_adapter_source0_valid;                                    // cool_s1_burst_adapter:source0_valid -> cool_s1_agent:cp_valid
	wire  [114:0] cool_s1_burst_adapter_source0_data;                                     // cool_s1_burst_adapter:source0_data -> cool_s1_agent:cp_data
	wire          cool_s1_burst_adapter_source0_ready;                                    // cool_s1_agent:cp_ready -> cool_s1_burst_adapter:source0_ready
	wire    [8:0] cool_s1_burst_adapter_source0_channel;                                  // cool_s1_burst_adapter:source0_channel -> cool_s1_agent:cp_channel
	wire          cool_s1_burst_adapter_source0_startofpacket;                            // cool_s1_burst_adapter:source0_startofpacket -> cool_s1_agent:cp_startofpacket
	wire          cool_s1_burst_adapter_source0_endofpacket;                              // cool_s1_burst_adapter:source0_endofpacket -> cool_s1_agent:cp_endofpacket
	...
	wire          router_004_src_valid;                                                   // router_004:src_valid -> ledverde_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_004_src_data;                                                    // router_004:src_data -> ledverde_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                   // ledverde_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [8:0] router_004_src_channel;                                                 // router_004:src_channel -> ledverde_s1_rsp_width_adapter:in_channel
	wire          router_004_src_startofpacket;                                           // router_004:src_startofpacket -> ledverde_s1_rsp_width_adapter:in_startofpacket
	wire          router_004_src_endofpacket;                                             // router_004:src_endofpacket -> ledverde_s1_rsp_width_adapter:in_endofpacket
	wire          ledverde_s1_rsp_width_adapter_src_valid;                                // ledverde_s1_rsp_width_adapter:out_valid -> rsp_demux_003:sink_valid
	wire  [150:0] ledverde_s1_rsp_width_adapter_src_data;                                 // ledverde_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	wire          ledverde_s1_rsp_width_adapter_src_ready;                                // rsp_demux_003:sink_ready -> ledverde_s1_rsp_width_adapter:out_ready
	wire    [8:0] ledverde_s1_rsp_width_adapter_src_channel;                              // ledverde_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	wire          ledverde_s1_rsp_width_adapter_src_startofpacket;                        // ledverde_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_003:sink_startofpacket
	wire          ledverde_s1_rsp_width_adapter_src_endofpacket;                          // ledverde_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_003:sink_endofpacket
	wire          router_005_src_valid;                                                   // router_005:src_valid -> ledvermelho_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_005_src_data;                                                    // router_005:src_data -> ledvermelho_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                   // ledvermelho_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [8:0] router_005_src_channel;                                                 // router_005:src_channel -> ledvermelho_s1_rsp_width_adapter:in_channel
	wire          router_005_src_startofpacket;                                           // router_005:src_startofpacket -> ledvermelho_s1_rsp_width_adapter:in_startofpacket
	wire          router_005_src_endofpacket;                                             // router_005:src_endofpacket -> ledvermelho_s1_rsp_width_adapter:in_endofpacket
	wire          ledvermelho_s1_rsp_width_adapter_src_valid;                             // ledvermelho_s1_rsp_width_adapter:out_valid -> rsp_demux_004:sink_valid
	wire  [150:0] ledvermelho_s1_rsp_width_adapter_src_data;                              // ledvermelho_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          ledvermelho_s1_rsp_width_adapter_src_ready;                             // rsp_demux_004:sink_ready -> ledvermelho_s1_rsp_width_adapter:out_ready
	wire    [8:0] ledvermelho_s1_rsp_width_adapter_src_channel;                           // ledvermelho_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	wire          ledvermelho_s1_rsp_width_adapter_src_startofpacket;                     // ledvermelho_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_004:sink_startofpacket
	wire          ledvermelho_s1_rsp_width_adapter_src_endofpacket;                       // ledvermelho_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_004:sink_endofpacket
	wire          router_006_src_valid;                                                   // router_006:src_valid -> button0_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_006_src_data;                                                    // router_006:src_data -> button0_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                   // button0_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [8:0] router_006_src_channel;                                                 // router_006:src_channel -> button0_s1_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                           // router_006:src_startofpacket -> button0_s1_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                             // router_006:src_endofpacket -> button0_s1_rsp_width_adapter:in_endofpacket
	wire          button0_s1_rsp_width_adapter_src_valid;                                 // button0_s1_rsp_width_adapter:out_valid -> rsp_demux_005:sink_valid
	wire  [150:0] button0_s1_rsp_width_adapter_src_data;                                  // button0_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          button0_s1_rsp_width_adapter_src_ready;                                 // rsp_demux_005:sink_ready -> button0_s1_rsp_width_adapter:out_ready
	wire    [8:0] button0_s1_rsp_width_adapter_src_channel;                               // button0_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	wire          button0_s1_rsp_width_adapter_src_startofpacket;                         // button0_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_005:sink_startofpacket
	wire          button0_s1_rsp_width_adapter_src_endofpacket;                           // button0_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_005:sink_endofpacket
	wire          router_007_src_valid;                                                   // router_007:src_valid -> ledextra_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_007_src_data;                                                    // router_007:src_data -> ledextra_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                   // ledextra_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [8:0] router_007_src_channel;                                                 // router_007:src_channel -> ledextra_s1_rsp_width_adapter:in_channel
	wire          router_007_src_startofpacket;                                           // router_007:src_startofpacket -> ledextra_s1_rsp_width_adapter:in_startofpacket
	wire          router_007_src_endofpacket;                                             // router_007:src_endofpacket -> ledextra_s1_rsp_width_adapter:in_endofpacket
	wire          ledextra_s1_rsp_width_adapter_src_valid;                                // ledextra_s1_rsp_width_adapter:out_valid -> rsp_demux_006:sink_valid
	wire  [150:0] ledextra_s1_rsp_width_adapter_src_data;                                 // ledextra_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	wire          ledextra_s1_rsp_width_adapter_src_ready;                                // rsp_demux_006:sink_ready -> ledextra_s1_rsp_width_adapter:out_ready
	wire    [8:0] ledextra_s1_rsp_width_adapter_src_channel;                              // ledextra_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	wire          ledextra_s1_rsp_width_adapter_src_startofpacket;                        // ledextra_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_006:sink_startofpacket
	wire          ledextra_s1_rsp_width_adapter_src_endofpacket;                          // ledextra_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_006:sink_endofpacket
	wire          router_008_src_valid;                                                   // router_008:src_valid -> cool_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_008_src_data;                                                    // router_008:src_data -> cool_s1_rsp_width_adapter:in_data
	wire          router_008_src_ready;                                                   // cool_s1_rsp_width_adapter:in_ready -> router_008:src_ready
	wire    [8:0] router_008_src_channel;                                                 // router_008:src_channel -> cool_s1_rsp_width_adapter:in_channel
	wire          router_008_src_startofpacket;                                           // router_008:src_startofpacket -> cool_s1_rsp_width_adapter:in_startofpacket
	wire          router_008_src_endofpacket;                                             // router_008:src_endofpacket -> cool_s1_rsp_width_adapter:in_endofpacket
	wire          cool_s1_rsp_width_adapter_src_valid;                                    // cool_s1_rsp_width_adapter:out_valid -> rsp_demux_007:sink_valid
	wire  [150:0] cool_s1_rsp_width_adapter_src_data;                                     // cool_s1_rsp_width_adapter:out_data -> rsp_demux_007:sink_data
	wire          cool_s1_rsp_width_adapter_src_ready;                                    // rsp_demux_007:sink_ready -> cool_s1_rsp_width_adapter:out_ready
	wire    [8:0] cool_s1_rsp_width_adapter_src_channel;                                  // cool_s1_rsp_width_adapter:out_channel -> rsp_demux_007:sink_channel
	wire          cool_s1_rsp_width_adapter_src_startofpacket;                            // cool_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_007:sink_startofpacket
	wire          cool_s1_rsp_width_adapter_src_endofpacket;                              // cool_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_007:sink_endofpacket
	...
	wire          cmd_mux_003_src_valid;                                                  // cmd_mux_003:src_valid -> ledverde_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_003_src_data;                                                   // cmd_mux_003:src_data -> ledverde_s1_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                  // ledverde_s1_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [8:0] cmd_mux_003_src_channel;                                                // cmd_mux_003:src_channel -> ledverde_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_003_src_startofpacket;                                          // cmd_mux_003:src_startofpacket -> ledverde_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                            // cmd_mux_003:src_endofpacket -> ledverde_s1_cmd_width_adapter:in_endofpacket
	wire          ledverde_s1_cmd_width_adapter_src_valid;                                // ledverde_s1_cmd_width_adapter:out_valid -> ledverde_s1_burst_adapter:sink0_valid
	wire  [114:0] ledverde_s1_cmd_width_adapter_src_data;                                 // ledverde_s1_cmd_width_adapter:out_data -> ledverde_s1_burst_adapter:sink0_data
	wire          ledverde_s1_cmd_width_adapter_src_ready;                                // ledverde_s1_burst_adapter:sink0_ready -> ledverde_s1_cmd_width_adapter:out_ready
	wire    [8:0] ledverde_s1_cmd_width_adapter_src_channel;                              // ledverde_s1_cmd_width_adapter:out_channel -> ledverde_s1_burst_adapter:sink0_channel
	wire          ledverde_s1_cmd_width_adapter_src_startofpacket;                        // ledverde_s1_cmd_width_adapter:out_startofpacket -> ledverde_s1_burst_adapter:sink0_startofpacket
	wire          ledverde_s1_cmd_width_adapter_src_endofpacket;                          // ledverde_s1_cmd_width_adapter:out_endofpacket -> ledverde_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_004_src_valid;                                                  // cmd_mux_004:src_valid -> ledvermelho_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_004_src_data;                                                   // cmd_mux_004:src_data -> ledvermelho_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                  // ledvermelho_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> ledvermelho_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_004_src_startofpacket;                                          // cmd_mux_004:src_startofpacket -> ledvermelho_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                            // cmd_mux_004:src_endofpacket -> ledvermelho_s1_cmd_width_adapter:in_endofpacket
	wire          ledvermelho_s1_cmd_width_adapter_src_valid;                             // ledvermelho_s1_cmd_width_adapter:out_valid -> ledvermelho_s1_burst_adapter:sink0_valid
	wire  [114:0] ledvermelho_s1_cmd_width_adapter_src_data;                              // ledvermelho_s1_cmd_width_adapter:out_data -> ledvermelho_s1_burst_adapter:sink0_data
	wire          ledvermelho_s1_cmd_width_adapter_src_ready;                             // ledvermelho_s1_burst_adapter:sink0_ready -> ledvermelho_s1_cmd_width_adapter:out_ready
	wire    [8:0] ledvermelho_s1_cmd_width_adapter_src_channel;                           // ledvermelho_s1_cmd_width_adapter:out_channel -> ledvermelho_s1_burst_adapter:sink0_channel
	wire          ledvermelho_s1_cmd_width_adapter_src_startofpacket;                     // ledvermelho_s1_cmd_width_adapter:out_startofpacket -> ledvermelho_s1_burst_adapter:sink0_startofpacket
	wire          ledvermelho_s1_cmd_width_adapter_src_endofpacket;                       // ledvermelho_s1_cmd_width_adapter:out_endofpacket -> ledvermelho_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_005_src_valid;                                                  // cmd_mux_005:src_valid -> button0_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_005_src_data;                                                   // cmd_mux_005:src_data -> button0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                  // button0_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                                // cmd_mux_005:src_channel -> button0_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_005_src_startofpacket;                                          // cmd_mux_005:src_startofpacket -> button0_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                            // cmd_mux_005:src_endofpacket -> button0_s1_cmd_width_adapter:in_endofpacket
	wire          button0_s1_cmd_width_adapter_src_valid;                                 // button0_s1_cmd_width_adapter:out_valid -> button0_s1_burst_adapter:sink0_valid
	wire  [114:0] button0_s1_cmd_width_adapter_src_data;                                  // button0_s1_cmd_width_adapter:out_data -> button0_s1_burst_adapter:sink0_data
	wire          button0_s1_cmd_width_adapter_src_ready;                                 // button0_s1_burst_adapter:sink0_ready -> button0_s1_cmd_width_adapter:out_ready
	wire    [8:0] button0_s1_cmd_width_adapter_src_channel;                               // button0_s1_cmd_width_adapter:out_channel -> button0_s1_burst_adapter:sink0_channel
	wire          button0_s1_cmd_width_adapter_src_startofpacket;                         // button0_s1_cmd_width_adapter:out_startofpacket -> button0_s1_burst_adapter:sink0_startofpacket
	wire          button0_s1_cmd_width_adapter_src_endofpacket;                           // button0_s1_cmd_width_adapter:out_endofpacket -> button0_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_006_src_valid;                                                  // cmd_mux_006:src_valid -> ledextra_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_006_src_data;                                                   // cmd_mux_006:src_data -> ledextra_s1_cmd_width_adapter:in_data
	wire          cmd_mux_006_src_ready;                                                  // ledextra_s1_cmd_width_adapter:in_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                // cmd_mux_006:src_channel -> ledextra_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_006_src_startofpacket;                                          // cmd_mux_006:src_startofpacket -> ledextra_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                            // cmd_mux_006:src_endofpacket -> ledextra_s1_cmd_width_adapter:in_endofpacket
	wire          ledextra_s1_cmd_width_adapter_src_valid;                                // ledextra_s1_cmd_width_adapter:out_valid -> ledextra_s1_burst_adapter:sink0_valid
	wire  [114:0] ledextra_s1_cmd_width_adapter_src_data;                                 // ledextra_s1_cmd_width_adapter:out_data -> ledextra_s1_burst_adapter:sink0_data
	wire          ledextra_s1_cmd_width_adapter_src_ready;                                // ledextra_s1_burst_adapter:sink0_ready -> ledextra_s1_cmd_width_adapter:out_ready
	wire    [8:0] ledextra_s1_cmd_width_adapter_src_channel;                              // ledextra_s1_cmd_width_adapter:out_channel -> ledextra_s1_burst_adapter:sink0_channel
	wire          ledextra_s1_cmd_width_adapter_src_startofpacket;                        // ledextra_s1_cmd_width_adapter:out_startofpacket -> ledextra_s1_burst_adapter:sink0_startofpacket
	wire          ledextra_s1_cmd_width_adapter_src_endofpacket;                          // ledextra_s1_cmd_width_adapter:out_endofpacket -> ledextra_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_007_src_valid;                                                  // cmd_mux_007:src_valid -> cool_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_007_src_data;                                                   // cmd_mux_007:src_data -> cool_s1_cmd_width_adapter:in_data
	wire          cmd_mux_007_src_ready;                                                  // cool_s1_cmd_width_adapter:in_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                // cmd_mux_007:src_channel -> cool_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_007_src_startofpacket;                                          // cmd_mux_007:src_startofpacket -> cool_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                            // cmd_mux_007:src_endofpacket -> cool_s1_cmd_width_adapter:in_endofpacket
	wire          cool_s1_cmd_width_adapter_src_valid;                                    // cool_s1_cmd_width_adapter:out_valid -> cool_s1_burst_adapter:sink0_valid
	wire  [114:0] cool_s1_cmd_width_adapter_src_data;                                     // cool_s1_cmd_width_adapter:out_data -> cool_s1_burst_adapter:sink0_data
	wire          cool_s1_cmd_width_adapter_src_ready;                                    // cool_s1_burst_adapter:sink0_ready -> cool_s1_cmd_width_adapter:out_ready
	wire    [8:0] cool_s1_cmd_width_adapter_src_channel;                                  // cool_s1_cmd_width_adapter:out_channel -> cool_s1_burst_adapter:sink0_channel
	wire          cool_s1_cmd_width_adapter_src_startofpacket;                            // cool_s1_cmd_width_adapter:out_startofpacket -> cool_s1_burst_adapter:sink0_startofpacket
	wire          cool_s1_cmd_width_adapter_src_endofpacket;                              // cool_s1_cmd_width_adapter:out_endofpacket -> cool_s1_burst_adapter:sink0_endofpacket
	...
	wire          ledverde_s1_agent_rdata_fifo_src_valid;                                 // ledverde_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] ledverde_s1_agent_rdata_fifo_src_data;                                  // ledverde_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          ledverde_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_003:in_0_ready -> ledverde_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                      // avalon_st_adapter_003:out_0_valid -> ledverde_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                       // avalon_st_adapter_003:out_0_data -> ledverde_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                      // ledverde_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                      // avalon_st_adapter_003:out_0_error -> ledverde_s1_agent:rdata_fifo_sink_error
	wire          ledvermelho_s1_agent_rdata_fifo_src_valid;                              // ledvermelho_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] ledvermelho_s1_agent_rdata_fifo_src_data;                               // ledvermelho_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          ledvermelho_s1_agent_rdata_fifo_src_ready;                              // avalon_st_adapter_004:in_0_ready -> ledvermelho_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                      // avalon_st_adapter_004:out_0_valid -> ledvermelho_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                       // avalon_st_adapter_004:out_0_data -> ledvermelho_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                      // ledvermelho_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                      // avalon_st_adapter_004:out_0_error -> ledvermelho_s1_agent:rdata_fifo_sink_error
	wire          button0_s1_agent_rdata_fifo_src_valid;                                  // button0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] button0_s1_agent_rdata_fifo_src_data;                                   // button0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          button0_s1_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_005:in_0_ready -> button0_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                      // avalon_st_adapter_005:out_0_valid -> button0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                       // avalon_st_adapter_005:out_0_data -> button0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                      // button0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                      // avalon_st_adapter_005:out_0_error -> button0_s1_agent:rdata_fifo_sink_error
	wire          ledextra_s1_agent_rdata_fifo_src_valid;                                 // ledextra_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] ledextra_s1_agent_rdata_fifo_src_data;                                  // ledextra_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          ledextra_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_006:in_0_ready -> ledextra_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                      // avalon_st_adapter_006:out_0_valid -> ledextra_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                       // avalon_st_adapter_006:out_0_data -> ledextra_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                      // ledextra_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                      // avalon_st_adapter_006:out_0_error -> ledextra_s1_agent:rdata_fifo_sink_error
	wire          cool_s1_agent_rdata_fifo_src_valid;                                     // cool_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] cool_s1_agent_rdata_fifo_src_data;                                      // cool_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          cool_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_007:in_0_ready -> cool_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                      // avalon_st_adapter_007:out_0_valid -> cool_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                       // avalon_st_adapter_007:out_0_data -> cool_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                      // cool_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                      // avalon_st_adapter_007:out_0_error -> cool_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) button0_s1_translator (
		.clk                    (pcie_hard_ip_0_pcie_core_clk_clk),         //                      clk.clk
		.reset                  (inport_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (button0_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (button0_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (button0_s1_agent_m0_read),                 //                         .read
		.uav_write              (button0_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (button0_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (button0_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (button0_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (button0_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (button0_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (button0_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (button0_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (button0_s1_address),                       //      avalon_anti_slave_0.address
		.av_readdata            (button0_s1_readdata),                      //                         .readdata
		.av_write               (),                                         //              (terminated)
		.av_read                (),                                         //              (terminated)
		.av_writedata           (),                                         //              (terminated)
		.av_begintransfer       (),                                         //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) ledextra_s1_translator (
		.clk                    (pcie_hard_ip_0_pcie_core_clk_clk),         //                      clk.clk
		.reset                  (inport_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (ledextra_s1_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (ledextra_s1_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (ledextra_s1_agent_m0_read),                //                         .read
		.uav_write              (ledextra_s1_agent_m0_write),               //                         .write
		.uav_waitrequest        (ledextra_s1_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (ledextra_s1_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (ledextra_s1_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (ledextra_s1_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (ledextra_s1_agent_m0_writedata),           //                         .writedata
		.uav_lock               (ledextra_s1_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (ledextra_s1_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (ledextra_s1_address),                      //      avalon_anti_slave_0.address
		.av_write               (ledextra_s1_write),                        //                         .write
		.av_readdata            (ledextra_s1_readdata),                     //                         .readdata
		.av_writedata           (ledextra_s1_writedata),                    //                         .writedata
		.av_chipselect          (ledextra_s1_chipselect),                   //                         .chipselect
		.av_read                (),                                         //              (terminated)
		.av_begintransfer       (),                                         //              (terminated)
		.av_beginbursttransfer  (),                                         //              (terminated)
		.av_burstcount          (),                                         //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (pcie_hard_ip_0_pcie_core_clk_clk),         //                      clk.clk
		.reset                  (inport_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (cool_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (cool_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (cool_s1_agent_m0_read),                    //                         .read
		.uav_write              (cool_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (cool_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (cool_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (cool_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (cool_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (cool_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (cool_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (cool_s1_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (cool_s1_address),                          //      avalon_anti_slave_0.address
		.av_write               (cool_s1_write),                            //                         .write
		.av_readdata            (cool_s1_readdata),                         //                         .readdata
		.av_writedata           (cool_s1_writedata),                        //                         .writedata
		.av_chipselect          (cool_s1_chipselect),                       //                         .chipselect
		.av_read                (),                                         //              (terminated)
		.av_begintransfer       (),                                         //              (terminated)
		.av_beginbursttransfer  (),                                         //              (terminated)
		.av_burstcount          (),                                         //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (ledverde_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (ledverde_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (ledverde_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (ledverde_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (ledverde_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (ledverde_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (ledvermelho_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (ledvermelho_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (ledvermelho_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (ledvermelho_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (ledvermelho_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (ledvermelho_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pcie_hard_ip_0_pcie_core_clk_clk),               //             clk.clk
		.reset                   (inport_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (button0_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (button0_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (button0_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (button0_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (button0_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (button0_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (button0_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (button0_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (button0_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (button0_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (button0_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (button0_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (button0_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (button0_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (button0_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (button0_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (button0_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (button0_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (button0_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (button0_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (button0_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (button0_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (button0_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (button0_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (button0_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (button0_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (button0_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (button0_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (button0_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (button0_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (button0_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (button0_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),              //                .error
		.rdata_fifo_src_ready    (button0_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (button0_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (button0_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) button0_s1_agent_rsp_fifo (
		.clk               (pcie_hard_ip_0_pcie_core_clk_clk),            //       clk.clk
		.reset             (inport_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (button0_s1_agent_rf_source_data),             //        in.data
		.in_valid          (button0_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (button0_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (button0_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (button0_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (button0_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (button0_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (button0_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (button0_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (button0_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pcie_hard_ip_0_pcie_core_clk_clk),                //             clk.clk
		.reset                   (inport_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (ledextra_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (ledextra_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (ledextra_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (ledextra_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (ledextra_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (ledextra_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (ledextra_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (ledextra_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (ledextra_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (ledextra_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (ledextra_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (ledextra_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (ledextra_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (ledextra_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (ledextra_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (ledextra_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (ledextra_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (ledextra_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (ledextra_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (ledextra_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (ledextra_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (ledextra_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (ledextra_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (ledextra_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (ledextra_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (ledextra_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (ledextra_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (ledextra_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (ledextra_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (ledextra_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (ledextra_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (ledextra_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),               //                .error
		.rdata_fifo_src_ready    (ledextra_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (ledextra_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (ledextra_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) ledextra_s1_agent_rsp_fifo (
		.clk               (pcie_hard_ip_0_pcie_core_clk_clk),             //       clk.clk
		.reset             (inport_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (ledextra_s1_agent_rf_source_data),             //        in.data
		.in_valid          (ledextra_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (ledextra_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (ledextra_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (ledextra_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (ledextra_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (ledextra_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (ledextra_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (ledextra_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (ledextra_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pcie_hard_ip_0_pcie_core_clk_clk),            //             clk.clk
		.reset                   (inport_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (cool_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (cool_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (cool_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (cool_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (cool_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (cool_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (cool_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (cool_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (cool_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (cool_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (cool_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (cool_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (cool_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (cool_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (cool_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (cool_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (cool_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (cool_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (cool_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (cool_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (cool_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (cool_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (cool_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (cool_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (cool_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (cool_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (cool_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (cool_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (cool_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (cool_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (cool_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (cool_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),           //                .error
		.rdata_fifo_src_ready    (cool_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (cool_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (cool_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                       //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                         //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) cool_s1_agent_rsp_fifo (
		.clk               (pcie_hard_ip_0_pcie_core_clk_clk),         //       clk.clk
		.reset             (inport_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (cool_s1_agent_rf_source_data),             //        in.data
		.in_valid          (cool_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (cool_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (cool_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (cool_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (cool_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (cool_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (cool_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (cool_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (cool_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                    // (terminated)
		.csr_read          (1'b0),                                     // (terminated)
		.csr_write         (1'b0),                                     // (terminated)
		.csr_readdata      (),                                         // (terminated)
	...
	pcihellocore_mm_interconnect_0_router_001 router_006 (
		.sink_ready         (button0_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (button0_s1_agent_rp_valid),                //          .valid
		.sink_data          (button0_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (button0_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (button0_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),         //       clk.clk
		.reset              (inport_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcihellocore_mm_interconnect_0_router_001 router_007 (
		.sink_ready         (ledextra_s1_agent_rp_ready),               //      sink.ready
		.sink_valid         (ledextra_s1_agent_rp_valid),               //          .valid
		.sink_data          (ledextra_s1_agent_rp_data),                //          .data
		.sink_startofpacket (ledextra_s1_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (ledextra_s1_agent_rp_endofpacket),         //          .endofpacket
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),         //       clk.clk
		.reset              (inport_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcihellocore_mm_interconnect_0_router_001 router_008 (
		.sink_ready         (cool_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (cool_s1_agent_rp_valid),                   //          .valid
		.sink_data          (cool_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (cool_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (cool_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),         //       clk.clk
		.reset              (inport_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (1),
		.ADAPTER_VERSION           ("13.1")
	) ledverde_s1_burst_adapter (
		.clk                   (pcie_hard_ip_0_pcie_core_clk_clk),                //       cr0.clk
		.reset                 (inport_reset_reset_bridge_in_reset_reset),        // cr0_reset.reset
		.sink0_valid           (ledverde_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (ledverde_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (ledverde_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (ledverde_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (ledverde_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (ledverde_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (ledverde_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (ledverde_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (ledverde_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (ledverde_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (ledverde_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (ledverde_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (1),
		.ADAPTER_VERSION           ("13.1")
	) ledvermelho_s1_burst_adapter (
		.clk                   (pcie_hard_ip_0_pcie_core_clk_clk),                   //       cr0.clk
		.reset                 (inport_reset_reset_bridge_in_reset_reset),           // cr0_reset.reset
		.sink0_valid           (ledvermelho_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (ledvermelho_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (ledvermelho_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (ledvermelho_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (ledvermelho_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (ledvermelho_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (ledvermelho_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (ledvermelho_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (ledvermelho_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (ledvermelho_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (ledvermelho_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (ledvermelho_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (1),
		.ADAPTER_VERSION           ("13.1")
	) button0_s1_burst_adapter (
		.clk                   (pcie_hard_ip_0_pcie_core_clk_clk),               //       cr0.clk
		.reset                 (inport_reset_reset_bridge_in_reset_reset),       // cr0_reset.reset
		.sink0_valid           (button0_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (button0_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (button0_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (button0_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (button0_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (button0_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (button0_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (button0_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (button0_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (button0_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (button0_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (button0_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (1),
		.ADAPTER_VERSION           ("13.1")
	) ledextra_s1_burst_adapter (
		.clk                   (pcie_hard_ip_0_pcie_core_clk_clk),                //       cr0.clk
		.reset                 (inport_reset_reset_bridge_in_reset_reset),        // cr0_reset.reset
		.sink0_valid           (ledextra_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (ledextra_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (ledextra_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (ledextra_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (ledextra_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (ledextra_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (ledextra_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (ledextra_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (ledextra_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (ledextra_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (ledextra_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (ledextra_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (1),
		.ADAPTER_VERSION           ("13.1")
	) cool_s1_burst_adapter (
		.clk                   (pcie_hard_ip_0_pcie_core_clk_clk),            //       cr0.clk
		.reset                 (inport_reset_reset_bridge_in_reset_reset),    // cr0_reset.reset
		.sink0_valid           (cool_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (cool_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (cool_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (cool_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (cool_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (cool_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (cool_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (cool_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (cool_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (cool_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (cool_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (cool_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	pcihellocore_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),                //       clk.clk
		.reset              (inport_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.sink_ready         (ledverde_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (ledverde_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (ledverde_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (ledverde_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (ledverde_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (ledverde_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	pcihellocore_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),                   //       clk.clk
		.reset              (inport_reset_reset_bridge_in_reset_reset),           // clk_reset.reset
		.sink_ready         (ledvermelho_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (ledvermelho_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (ledvermelho_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (ledvermelho_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (ledvermelho_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (ledvermelho_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	pcihellocore_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),               //       clk.clk
		.reset              (inport_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.sink_ready         (button0_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (button0_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (button0_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (button0_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (button0_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (button0_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	pcihellocore_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),                //       clk.clk
		.reset              (inport_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.sink_ready         (ledextra_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (ledextra_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (ledextra_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (ledextra_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (ledextra_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (ledextra_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	pcihellocore_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),            //       clk.clk
		.reset              (inport_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.sink_ready         (cool_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (cool_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (cool_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (cool_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (cool_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (cool_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (ledverde_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (ledverde_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (ledverde_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (ledverde_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (ledverde_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (ledverde_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                           // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) ledvermelho_s1_rsp_width_adapter (
		.clk                  (pcie_hard_ip_0_pcie_core_clk_clk),                   //       clk.clk
		.reset                (inport_reset_reset_bridge_in_reset_reset),           // clk_reset.reset
		...
		.out_endofpacket      (ledvermelho_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (ledvermelho_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (ledvermelho_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (ledvermelho_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (ledvermelho_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (ledvermelho_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                              // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (button0_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (button0_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (button0_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (button0_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (button0_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (button0_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                          // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (ledextra_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (ledextra_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (ledextra_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (ledextra_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (ledextra_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (ledextra_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                           // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (cool_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (cool_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (cool_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (cool_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (cool_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (cool_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                       // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (ledverde_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (ledverde_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (ledverde_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (ledverde_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (ledverde_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (ledverde_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                           // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) ledvermelho_s1_cmd_width_adapter (
		.clk                  (pcie_hard_ip_0_pcie_core_clk_clk),                   //       clk.clk
		.reset                (inport_reset_reset_bridge_in_reset_reset),           // clk_reset.reset
		...
		.out_endofpacket      (ledvermelho_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (ledvermelho_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (ledvermelho_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (ledvermelho_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (ledvermelho_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (ledvermelho_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                              // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (button0_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (button0_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (button0_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (button0_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (button0_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (button0_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                          // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (ledextra_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (ledextra_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (ledextra_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (ledextra_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (ledextra_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (ledextra_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                           // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (cool_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (cool_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (cool_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (cool_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (cool_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (cool_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                       // (terminated)
	);
	...
	pcihellocore_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pcie_hard_ip_0_pcie_core_clk_clk),         // in_clk_0.clk
		.in_rst_0_reset (inport_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (button0_s1_agent_rdata_fifo_src_data),     //     in_0.data
		.in_0_valid     (button0_s1_agent_rdata_fifo_src_valid),    //         .valid
		.in_0_ready     (button0_s1_agent_rdata_fifo_src_ready),    //         .ready
	...
	pcihellocore_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pcie_hard_ip_0_pcie_core_clk_clk),         // in_clk_0.clk
		.in_rst_0_reset (inport_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (ledextra_s1_agent_rdata_fifo_src_data),    //     in_0.data
		.in_0_valid     (ledextra_s1_agent_rdata_fifo_src_valid),   //         .valid
		.in_0_ready     (ledextra_s1_agent_rdata_fifo_src_ready),   //         .ready
	...
	pcihellocore_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pcie_hard_ip_0_pcie_core_clk_clk),         // in_clk_0.clk
		.in_rst_0_reset (inport_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (cool_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (cool_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (cool_s1_agent_rdata_fifo_src_ready),       //         .ready
